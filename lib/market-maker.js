...
function calcShares(tokens, outcomeIndex, shareDistributionRaw, initialFunding) {
  // TODO move this to index
  var maxShares = shareDistributionRaw.reduce(function (maximum, shareCount) {
    return shareCount.greaterThan(maximum) ? shareCount : maximum;
  }, new _bignumber2.default('0'));

  var shareDistribution = shareDistributionRaw.map(function (shareCount) {
